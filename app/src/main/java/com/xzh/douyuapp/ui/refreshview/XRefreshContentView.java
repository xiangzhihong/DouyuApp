package com.xzh.douyuapp.ui.refreshview;
...
import com.xzh.douyuapp.ui.refreshview.callback.IFooterCallBack;
import com.xzh.douyuapp.ui.refreshview.listener.OnBottomLoadMoreTime;
import com.xzh.douyuapp.ui.refreshview.listener.OnTopRefreshTime;
import com.xzh.douyuapp.ui.refreshview.recyclerview.BaseRecyclerAdapter;
import com.xzh.douyuapp.ui.refreshview.recyclerview.XSpanSizeLookup;
import com.xzh.douyuapp.ui.refreshview.utils.Utils;
...
public class XRefreshContentView implements OnScrollListener, OnTopRefreshTime, OnBottomLoadMoreTime {
    ...
    public void onRecyclerViewScrolled(RecyclerView recyclerView, BaseRecyclerAdapter adapter, int dx, int dy, boolean force) {
        ...
        Log.d("test pre onScrolled mIsLoadingMore=" + mIsLoadingMore);
