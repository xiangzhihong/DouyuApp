...
public class HomeColumnMoreOtherListAdapter extends BaseRecyclerAdapter<RecyclerView.ViewHolder> {
    ...
    private List<HomeColumnMoreOtherList> mLiveList;
    private Context context;

    public HomeColumnMoreOtherListAdapter(Context context) {
        this.context = context;
        this.mLiveList = new ArrayList<HomeColumnMoreOtherList>();
    }

    public void getLiveAllList(List<HomeColumnMoreOtherList> mLiveList) {
...
//        notifyItemInserted(this.mLiveList.size());
    ...
    public void getLiveAllListLoadMore(List<HomeColumnMoreOtherList> mLiveList) {
//        notifyItemRangeChanged(this.mLiveList.size(),this.mLiveList.size());
        this.mLiveList.addAll(mLiveList);
        notifyDataSetChanged();
    }
